...
| `Readiness-Brief-Formula-Distribuidora.pdf` / `.html` | O readiness brief real (1 página, 24 fontes, cada linha CONFIRMADO / HIPÓTESE / DESCONHECIDO com link). Empresa X (fictícia, fabricante de aditivos) → Fórmula Distribuidora Automotiva, comprador Paulo Brenha. Montado à mão + @analyst, com as mesmas fontes que o sistema usa |
